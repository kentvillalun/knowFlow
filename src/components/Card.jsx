  ...
  return (
    <>
      <div className="bg-white shadow-lg p-6 rounded-xl flex flex-col gap-2 col-span-2 md:col-span-1 lg:order-1">
        ...
        <textarea name="focus" id="focus" rows={3} className="w-full p-3 border-2 rounded-xl text-gray-400 focus:border-violet-700 focus:outline-0" placeholder="Ex. Build the Entries page layout and practice component separation." value={value} onChange={onChange}></textarea>
